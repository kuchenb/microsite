$env:DTC_SITETHEME = "https://docs-as-code.gitpages.tech.rz.db.de/templates/sitetheme-bahn-ng/images/micrositeTheme-Bahn-2.0.zip"
...
elseif ($docker) {
    ...
    $command = "$docker_cmd run --rm -it --entrypoint /bin/bash -v ${PWD}:/project 'docker-hub-remote.bahnhub.tech.rz.db.de/doctoolchain/doctoolchain:v$version' -c ""doctoolchain . $commandArgs $DTC_OPTS && exit"""
}
else {

...
Auf der 1. Ebene ist es sinnvoll das API-First-Prinzip zu berücksichtugen. Das bedeutet, man sollte spätestens hier prüfen, welche Schnittstellen Art von Schnittstellen (UI und API) für einen Use Case unterstützt werden sollen. Für diese Entscheidung sind entsprechende Architekturentscheidungen zu definieren.     
****
